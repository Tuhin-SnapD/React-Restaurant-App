        ...
        <div className="row row-content">
          ...
          <div className="col-12 col-sm-4 offset-sm-1 mt-4">
            ...
            <address>
              ...
              iruvalam Rd, Katpadi, Vellore,<br />
              Tamil Nadu 632014<br />
              <i className="fa fa-phone"></i>: +0416-220-2020<br />
              <i className="fa fa-fax"></i>: +0416-220-2020<br />
              <i className="fa fa-envelope"></i>: <a href="mailto:tuhinchakrabarty14@gmail.com">confusion@food.net</a>
            </address>
          </div>
          <div className="col-12 col-sm-6 offset-sm-1 mt-3">
            <h5>Map of our Location</h5>
            <img src='assets/images/map.png' height="280" width="auto" alt='Map' style={MapStyle} />
          </div>
